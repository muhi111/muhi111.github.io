...
export function LayoutProvider({ children }: { children: ReactNode }) {
  ...
  const [isSidebarOpen, setIsSidebarOpen] = useState(() => {
    if (typeof window !== "undefined") {
      return !window.matchMedia(`(max-width: ${LAYOUT_CONSTANTS.NARROW_SCREEN_BREAKPOINT}px)`)
        .matches;
    }
    return false;
  });
  ...
  return (
    <LayoutContext.Provider value={{ isSidebarOpen, setIsSidebarOpen, isNarrowScreen }}>
      {children}
