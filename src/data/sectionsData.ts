export interface SectionItem {
  ...
  endMonth?: string;
  title: string;
  iconType: "education" | "certification" | "achievement" | "work" | "internship" | "tech";
  description?: string;
  isCurrent?: boolean;
}
...
const educationDataRaw: SectionItem[] = [
  ...
  },
  {
    ...
    iconType: "education",
    description:
      "工学全般に興味があり特定の学科を選びたくなかったため、2年進級時に学科を選ぶ方式の東京工業大学に進学。大学入学後にOSやコンパイラなどの低レイヤーに興味を持ち、情報通信系を選択。",
    isCurrent: true,
  },
  {
    id: "42tokyo-entry",
...
export const certificationsAndAchievementsData = sortByDate(certificationsAndAchievementsDataRaw);
...
const internshipsDataRaw: SectionItem[] = [
  ...
  },
  {
    ...
    iconType: "internship",
    description: "求人サイトをフルスタックで開発する1weekのインターンシップに参加。",
  },
  {
    ...
    iconType: "internship",
    description:
      "アプリケーションのバックエンド開発に携わる長期インターンシップに参加。APIやバッチ処理などバックエンドの幅広い分野について新規機能作成や既存機能の改善を実施。",
  },
  {
    id: "hatena-intern",
    year: "2025",
  ...
  },
  {
    ...
    iconType: "internship",
    description:
      "SREとして開発・運用の改善や自動化に携わる。ECSの不要イメージの削除やTerraformでの開発者体験向上、Grafanaのダッシュボード改善などを実施。",
  },
];
