...
export const worksData: Work[] = [
  ...
  },
  {
    ...
    description: `GMO インターネットグループ株式会社 5daysインターン内の「ConoHaのコンパネを改良する」というお題のハッカソンで作成したConoHaのコントロールパネル。
                  ...
                  フロントエンドの一部とデプロイを担当。`,
    achievements: ["GMOインターネットグループ株式会社 2024年5daysインターン&ハッカソン 最優秀賞"],
  ...
  {
    title: "reminder",
    description: `lineを用いたリマインダーサービス。
                  lineのメッセージでリマインダーを登録すると、指定した日時にlineで通知が届く。`,
    achievements: [],
    tags: [
      "Go",
      "Echo",
    ...
    githubLink: "https://github.com/muhi111/reminder",
    liveLink: "",
  },
  {
    title: "tsumitan",
    description: `単語学習を支援するためのサイト。
    辞書代わりにこのサイトから検索することで調べた履歴に基づいて単語帳を自動生成し、復習できる。`,
    achievements: [],
    tags: [
      "React",
      "TypeScript",
    ...
    githubLink: "https://github.com/muhi111/tsumitan",
    liveLink: "https://tsumitan.muhi111.com/",
  },
];
